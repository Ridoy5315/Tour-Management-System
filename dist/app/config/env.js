...
const loadEnvVariables = () => {
    ...
    return {
        ...
        SSL: {
            ...
            SSL_PAYMENT_API: process.env.SSLCOMMERZ_PAYMENT_API,
            SSL_VALIDATION_API: process.env.SSLCOMMERZ_VALIDATION_API,
            SSL_SUCCESS_BACKEND_URL: process.env
                .SSLCOMMERZ_SUCCESS_BACKEND_URL,
            SSL_FAIL_BACKEND_URL: process.env.SSLCOMMERZ_FAIL_BACKEND_URL,
            SSL_CANCEL_BACKEND_URL: process.env
                .SSLCOMMERZ_CANCEL_BACKEND_URL,
            SSL_SUCCESS_FRONTEND_URL: process.env
                .SSLCOMMERZ_SUCCESS_FRONTEND_URL,
            SSL_FAIL_FRONTEND_URL: process.env.SSLCOMMERZ_FAIL_FRONTEND_URL,
