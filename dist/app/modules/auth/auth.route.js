...
router.get("/google/callback", passport_1.default.authenticate("google", { failureRedirect: `${env_1.envVars.FRONTEND_URL}/login?error=There is some issues with your account. PLease contact with our support team!` }), auth_controller_1.AuthControllers.googleCallback);
