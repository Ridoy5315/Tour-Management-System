...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            store_passwd: env_1.envVars.SSL.STORE_PASSWORD,
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, axios_1.default)({
            method: "GET",
            url: `${env_1.envVars.SSL.SSL_VALIDATION_API}?val_id=${payload.val_id}&store_id=${env_1.envVars.SSL.STORE_ID}&store_passwd=${env_1.envVars.SSL.STORE_PASSWORD}`,
        });
        console.log("sslcommerz validate api response", response.data);
        yield payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, { paymentGatewayDate: response.data }, { runValidator: true });
    }
    catch (error) {
        console.log(error);
