...
const redis_consfig_1 = require("../../config/redis.consfig");
...
const sendOTP = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield redis_consfig_1.redisClient.set(redisKey, otp, {
        expiration: {
            type: "EX",
...
const verifyOTP = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const redisKey = `otp:${email}`;
    const savedOtp = yield redis_consfig_1.redisClient.get(redisKey);
    if (!savedOtp) {
    ...
    yield Promise.all([
        ...
        redis_consfig_1.redisClient.del([redisKey]),
    ]);
});
exports.OTPServices = {
    sendOTP,
